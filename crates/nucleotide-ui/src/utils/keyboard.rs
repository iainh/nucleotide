...
impl ShortcutRegistry {
    ...
    pub fn load_defaults(&mut self) {
        ...
        self.register(KeyboardShortcut::new("s", ModifierSet::platform().with_shift()), "save_as");
        self.register(KeyboardShortcut::cmd("z"), "undo");
        self.register(KeyboardShortcut::new("z", ModifierSet::platform().with_shift()), "redo");
        ...
        self.register(KeyboardShortcut::new("f", ModifierSet::platform().with_shift()), "find_in_files");
...
mod tests {
    ...
    fn test_shortcut_matching() {
        ...
        let matching_event = create_key_event("s", Modifiers {
            platform: true,
            control: false,
            alt: false,
            shift: false,
        ...
        let non_matching_event = create_key_event("s", Modifiers {
            platform: false,
            control: true,
            alt: false,
            shift: false,
    ...
    fn test_shortcut_registry() {
        ...
        let event = create_key_event("s", Modifiers {
            platform: true,
            control: false,
            alt: false,
            shift: false,
    ...
    fn test_input_validation() {
        let text_event = create_key_event("a", Modifiers {
            platform: false,
            control: false,
            alt: false,
            shift: false,
        ...
        let shortcut_event = create_key_event("s", Modifiers {
            platform: true,
            control: false,
            alt: false,
            shift: false,
    ...
    fn test_shortcut_string_representation() {
        ...
        let expected_complex = if cfg!(target_os = "macos") { "⌘+⇧+z" } else { "Ctrl+⇧+z" };
