...
use crate::Theme;
use gpui::{Hsla, Pixels, px, SharedString};
...
impl ThemeBuilder {
    ...
    pub fn text_color(mut self, color: Hsla) -> Self {
        self.color_overrides.insert("text_primary".to_string(), color);
        self
    }
    
    /// Set secondary text color
    pub fn text_secondary_color(mut self, color: Hsla) -> Self {
        self.color_overrides.insert("text_secondary".to_string(), color);
        self
    }
    
    /// Set border color
    pub fn border_color(mut self, color: Hsla) -> Self {
        self.color_overrides.insert("border_default".to_string(), color);
        self
    }
    ...
    pub fn spacing_scale(mut self, scale: f32) -> Self {
        ...
        self.size_overrides.insert("space_1".to_string(), px(base_space.0 * scale));
        self.size_overrides.insert("space_2".to_string(), px(base_space.0 * 2.0 * scale));
        self.size_overrides.insert("space_3".to_string(), px(base_space.0 * 3.0 * scale));
        self.size_overrides.insert("space_4".to_string(), px(base_space.0 * 4.0 * scale));
        self
    }
    ...
    pub fn radius_scale(mut self, scale: f32) -> Self {
        ...
        self.size_overrides.insert("radius_sm".to_string(), px(base_radius.0 * scale));
        self.size_overrides.insert("radius_md".to_string(), px(base_radius.0 * 2.0 * scale));
        self.size_overrides.insert("radius_lg".to_string(), px(base_radius.0 * 3.0 * scale));
        self
    }
        ...
        match key {
            ...
            _ => {
                nucleotide_logging::debug!(
                    color_key = key,
                    "Unknown color key in theme builder"
                );
            }
        }
    }
    ...
    fn apply_size_override(&self, theme: &mut Theme, key: &str, size: Pixels) {
        match key {
            ...
            _ => {
                nucleotide_logging::debug!(
                    size_key = key,
                    "Unknown size key in theme builder"
                );
            }
        }
    }
...
impl std::fmt::Display for ThemeBuildError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ThemeBuildError::InsufficientContrast { pair, actual, required } => {
                write!(f, "Insufficient contrast for {}: {:.2} (required: {:.2})", pair, actual, required)
            }
...
impl ThemeTemplates {
    ...
    pub fn material(primary: Hsla) -> ThemeBuilder {
        ThemeBuilder::light()
            ...
            .secondary_color(Hsla { h: primary.h + 30.0, s: primary.s * 0.8, l: primary.l, a: 1.0 })
            .background_color(Hsla { h: 0.0, s: 0.0, l: 0.98, a: 1.0 })
            .surface_color(Hsla { h: 0.0, s: 0.0, l: 1.0, a: 1.0 })
            .radius_scale(1.2)
            .spacing_scale(1.0)
    }
    ...
    pub fn high_contrast() -> ThemeBuilder {
        ThemeBuilder::light()
            ...
            .background_color(Hsla { h: 0.0, s: 0.0, l: 1.0, a: 1.0 })
            .text_color(Hsla { h: 0.0, s: 0.0, l: 0.0, a: 1.0 })
            .primary_color(Hsla { h: 220.0, s: 1.0, l: 0.3, a: 1.0 })
            .border_color(Hsla { h: 0.0, s: 0.0, l: 0.0, a: 1.0 })
            .validation(|v| {
    ...
    pub fn dark_accent(accent: Hsla) -> ThemeBuilder {
        ThemeBuilder::dark()
            ...
            .secondary_color(Hsla { h: accent.h + 60.0, s: accent.s * 0.7, l: accent.l, a: 1.0 })
    }
    ...
    pub fn monochrome(is_dark: bool) -> ThemeBuilder {
        ...
        builder
            ...
            .primary_color(Hsla { h: 0.0, s: 0.0, l: primary_lightness, a: 1.0 })
            .secondary_color(Hsla { h: 0.0, s: 0.0, l: primary_lightness * 0.7, a: 1.0 })
    }
}
...
mod tests {
    ...
    fn test_theme_builder_basic() {
        let theme = ThemeBuilder::new()
            .name("test-theme")
            .primary_color(Hsla { h: 200.0, s: 0.8, l: 0.5, a: 1.0 })
            .build()
            .unwrap();
        
        assert_eq!(theme.tokens.colors.primary, Hsla { h: 200.0, s: 0.8, l: 0.5, a: 1.0 });
    }
    ...
    fn test_theme_builder_fluent_api() {
        let theme = ThemeBuilder::light()
            .name("fluent-test")
            .primary_color(Hsla { h: 220.0, s: 0.9, l: 0.6, a: 1.0 })
            .secondary_color(Hsla { h: 180.0, s: 0.7, l: 0.5, a: 1.0 })
            .spacing_scale(1.2)
            .radius_scale(0.8)
            .build()
            .unwrap();
        ...
        assert_eq!(theme.tokens.colors.primary, Hsla { h: 220.0, s: 0.9, l: 0.6, a: 1.0 });
        assert_eq!(theme.tokens.colors.text_secondary, Hsla { h: 180.0, s: 0.7, l: 0.5, a: 1.0 });
    }
    
    #[test]
    fn test_theme_templates() {
        let material = ThemeTemplates::material(Hsla { h: 200.0, s: 0.8, l: 0.5, a: 1.0 })
            .build()
            .unwrap();
        
        assert!(!material.is_dark());
        assert_eq!(material.tokens.colors.primary, Hsla { h: 200.0, s: 0.8, l: 0.5, a: 1.0 });
        
        let high_contrast = ThemeTemplates::high_contrast()
            .build()
            .unwrap();
        
        assert_eq!(high_contrast.tokens.colors.background, Hsla { h: 0.0, s: 0.0, l: 1.0, a: 1.0 });
        assert_eq!(high_contrast.tokens.colors.text_primary, Hsla { h: 0.0, s: 0.0, l: 0.0, a: 1.0 });
    }
    
    #[test]
    fn test_contrast_validation() {
        let result = ThemeBuilder::new()
            .background_color(Hsla { h: 0.0, s: 0.0, l: 0.9, a: 1.0 })
            .text_color(Hsla { h: 0.0, s: 0.0, l: 0.85, a: 1.0 }) // Low contrast
    ...
    fn test_animation_configuration() {
        ...
        assert_eq!(builder.animation.default_duration, std::time::Duration::from_millis(300));
