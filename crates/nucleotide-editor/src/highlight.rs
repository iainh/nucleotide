...
use helix_view::{
    ...
    document::Mode,
    graphics::{Color, CursorKind, Modifier, Style},
};
...
fn apply_font_modifiers(base_font: &Font, style: &Style) -> Font {
...
fn helix_color_to_hsla(color: Color) -> Option<Hsla> {
    match color {
